...
CREATE TABLE PERFORMERS ( PERFORMER_ID INT GENERATED ALWAYS AS IDENTITY (START WITH 1 INCREMENT BY 1) PRIMARY KEY, PERFORMER_NAME VARCHAR(255), PERFORMER_TYPE INT, CONSTRAINT PERFORMER_TYPE_FK FOREIGN KEY (PERFORMER_TYPE) REFERENCES PERFORMER_TYPE (PERFORMER_TYPE) );
CREATE TABLE EVENTS ( EVENT_ID INT PRIMARY KEY, EVENT_NAME VARCHAR(255) NOT NULL, VENUE_ID INT NOT NULL, EVENT_DATE DATE NOT NULL, START_TIME VARCHAR(255) NOT NULL, END_TIME VARCHAR(255) NOT NULL, ORGANIZER_ID INT NOT NULL, PERFORMER_ID INT NOT NULL, EVENT_CATEGORY_ID INT NOT NULL, NUM_OF_TICKETS INT NOT NULL, NUM_OF_VIP_TICKETS INT NOT NULL, CONSTRAINT VENUE_FK FOREIGN KEY (VENUE_ID) REFERENCES VENUES (VENUE_ID), CONSTRAINT ORGANIZER_FK FOREIGN KEY (ORGANIZER_ID) REFERENCES ORGANIZERS (ORGANIZER_ID), CONSTRAINT PERFORMER_FK FOREIGN KEY (PERFORMER_ID) REFERENCES PERFORMERS (PERFORMER_ID), CONSTRAINT EVENT_CATEGORY_FK FOREIGN KEY (EVENT_CATEGORY_ID) REFERENCES EVENT_CATEGORY (EVENT_CATEGORY_ID) );
