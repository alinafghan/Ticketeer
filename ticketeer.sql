...
insert into ticket_type (ticket_type_name,ticket_type) values ('VIP',1);
...
BEGIN
  ...
  insert into tickets(event_id,ticket_type,venue_id,booked) values (:new.event_id,0,:new.venue_id,'n');
  n2 := n2+1;
  end loop;
END;
...
BEGIN 
  BEGIN 
    ...
    INTO :NEW.SEAT_NUM 
    FROM SEATS 
    WHERE VENUE_ID = :NEW.VENUE_ID AND BOOKED = 'n' 
    FETCH FIRST 1 ROW ONLY;

    -- Mark the seat as booked 
    UPDATE SEATS 
    SET BOOKED = 'y' 
    WHERE SEAT_NUM = :NEW.SEAT_NUM; 
  EXCEPTION 
